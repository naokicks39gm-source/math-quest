...
const PATTERN_IDS = [
  ...
  "COUNT_CIRCULAR",
  "COUNT_COMBINATION",
  "COUNT_EXCLUDE_SPECIFIC",
  "COUNT_GENERAL",
  "COUNT_GROUP_LABELED",
  "COUNT_GROUP_SIZED",
  "COUNT_GROUP_UNLABELED",
  "COUNT_INCLUDE_SPECIFIC",
  "COUNT_LISTING",
  "COUNT_NCR",
  "COUNT_NPR",
  "COUNT_PERMUTATION",
  ...
  "POW_INT",
  "PROB_BASIC_DIE_EVEN",
  "PROB_BASIC_DIE_SINGLE",
  "PROB_BAYES_BOX",
  "PROB_BAYES_LOTTERY",
  "PROB_BAYES_URN",
  "PROB_BINOMIAL_AT_LEAST_THREE_OF_SIX",
  "PROB_BINOMIAL_AT_MOST_TWO_OF_FOUR",
  "PROB_BINOMIAL_AT_MOST_TWO_OF_SIX",
  "PROB_BINOMIAL_DIE_AT_LEAST_ONE_SIX_OF_FIVE",
  "PROB_BINOMIAL_DIE_TWO_ONES_OF_FIVE",
  "PROB_BINOMIAL_EXACT_THREE_OF_FIVE",
  "PROB_BINOMIAL_EXACT_THREE_OF_SIX",
  "PROB_BINOMIAL_EXACT_TWO_OF_FOUR",
  "PROB_BINOMIAL_EXACT_TWO_OF_THREE",
  "PROB_CARD_FACE",
  "PROB_CARD_SAME",
  "PROB_CARD_SPADE",
  "PROB_CARD_SUM_7",
  "PROB_CARD_TWO_HEARTS",
  "PROB_COIN_SINGLE",
  "PROB_COMPLEMENT_AT_LEAST_ONE_HEAD",
  "PROB_COMPLEMENT_AT_LEAST_ONE_SIX",
  "PROB_COMPLEMENT_NOT_ONE",
  "PROB_COND_ALL_HEADS_GIVEN_AT_LEAST_ONE",
  "PROB_COND_ALL_HEADS_GIVEN_ONE",
  "PROB_COND_AT_LEAST_ONE_HEART",
  "PROB_COND_EVEN_THEN_FOUR",
  "PROB_COND_LOTTERY",
  "PROB_COND_RED_THEN_HEART",
  "PROB_COND_SECOND_RED",
  "PROB_COND_SUM_EVEN",
  "PROB_CONSECUTIVE_HEADS_THREE",
  "PROB_DICE_SAME",
  "PROB_DICE_SUM_7",
  "PROB_GENERAL_ALL_DIFFERENT_FOUR",
  "PROB_GENERAL_AT_LEAST_FOUR_HEADS_SIX",
  "PROB_GENERAL_AT_LEAST_ONE_ACE_THREE",
  "PROB_GENERAL_CONSECUTIVE_TWO_HEADS_FIVE",
  "PROB_GENERAL_SUM_TEN_THREE",
  "PROB_INDEPENDENT_ALL_HEADS",
  "PROB_INDEPENDENT_BOTH_EVEN",
  "PROB_TREE_HEAD_HEAD",
  "PROB_TREE_ONE_EACH",
  "PROB_URN_AT_LEAST_ONE_RED",
  "PROB_URN_RED2_WHITE1",
  "PROB_URN_RED2_WHITE1_OF3",
  "PROB_URN_RED_ONE",
  "PROB_URN_RED_WHITE",
  "PROB_URN_SAME_COLOR",
  "PROB_URN_TWO_RED",
  ...
  "QUAD_EXT_GENERAL",
  "QUAD_EXT_INTERVAL",
  "QUAD_EXT_LITERAL_CASE",
  "QUAD_EXT_LITERAL_COMPLETE",
  "QUAD_EXT_LITERAL_ENDPOINT",
  "QUAD_EXT_LITERAL_GENERAL",
  "QUAD_EXT_LITERAL_INTERVAL",
  "QUAD_EXT_LITERAL_MAX_BASIC",
  "QUAD_EXT_LITERAL_MIN_BASIC",
  "QUAD_EXT_LITERAL_VERTEX",
  "QUAD_EXT_LITERAL_VERTEX_FORM",
  "QUAD_EXT_LITERAL_VERTEX_POS",
  "QUAD_EXT_MAX_DOWNWARD",
  "QUAD_EXT_MAX_NO_INTERVAL",
  "QUAD_EXT_MIN_BASIC",
  "QUAD_EXT_MIN_COMPLETE",
  "QUAD_EXT_MIN_UPWARD",
  "QUAD_EXT_MIN_VERTEX",
  "QUAD_EXT_VERTEX_OUTSIDE",
  "QUAD_FUNC_AXIS",
  "QUAD_FUNC_AXIS_VERTEX",
  "QUAD_FUNC_COMPLETE_SQUARE",
  "QUAD_FUNC_GENERAL",
  "QUAD_FUNC_GRAPH_READ",
  "QUAD_FUNC_OPENING",
  "QUAD_FUNC_TRANSLATE_HORIZONTAL",
  "QUAD_FUNC_TRANSLATE_VERTICAL",
  "QUAD_FUNC_VERTEX",
  "QUAD_FUNC_VERTEX_BASIC",
  "QUAD_FUNC_VERTEX_FORM",
  "QUAD_INEQ_ALL_REAL",
  "QUAD_INEQ_ALL_REAL_COMPLETE",
  "QUAD_INEQ_BASIC",
  "QUAD_INEQ_DIFF_SQ",
  "QUAD_INEQ_DISC_APPLICATION",
  "QUAD_INEQ_DISC_CONDITION",
  "QUAD_INEQ_DISC_PROOF",
  "QUAD_INEQ_DOUBLE_ROOT",
  "QUAD_INEQ_FACTOR",
  "QUAD_INEQ_FORMULA",
  "QUAD_INEQ_FORMULA_COEFF",
  "QUAD_INEQ_FORMULA_FRACTION",
  "QUAD_INEQ_FORMULA_IRRATIONAL",
  "QUAD_INEQ_GRAPH",
  "QUAD_INEQ_INTERVAL",
  "QUAD_INEQ_LITERAL",
  "QUAD_INEQ_LITERAL_COMPLETE",
  "QUAD_INEQ_NEGATE",
  "QUAD_INEQ_NO_SOLUTION",
  "QUAD_INEQ_ONE_POINT",
  "QUAD_INEQ_SIGN_REVERSE",
  "QUAD_REL_COUNT",
  "QUAD_REL_DISC_CONDITION",
  "QUAD_REL_GENERAL",
  "QUAD_REL_INTERSECTION",
  "QUAD_REL_LINE_INTERSECTION",
  "QUAD_REL_LITERAL_CONDITION",
  "QUAD_REL_NO_INTERSECTION",
  "QUAD_REL_RANGE",
  "QUAD_REL_TANGENT_K",
  "QUAD_REL_TANGENT_POINT",
  "QUAD_ROOTS",
  ...
  "QUAD_ROOTS_FORMULA_A_NOT_1",
  "QUAD_ROOTS_FORMULA_BASIC",
  "QUAD_ROOTS_FORMULA_COEFF",
  "QUAD_ROOTS_FORMULA_DECIMAL",
  "QUAD_ROOTS_FORMULA_DISC_NON_SQUARE",
  "QUAD_ROOTS_FORMULA_DISC_SQUARE",
  "QUAD_ROOTS_FORMULA_FRACTION",
  "QUAD_ROOTS_FORMULA_GENERAL",
  "QUAD_ROOTS_FORMULA_IRRATIONAL",
  "QUAD_ROOTS_FORMULA_NEG_B",
  "QUAD_ROOTS_FORMULA_NEG_COEFF",
  "QUAD_ROOTS_FORMULA_REARRANGED",
  "QUAD_ROOTS_SQ_BASIC",
  "QUAD_ROOTS_SQ_COEFF",
