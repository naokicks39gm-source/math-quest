...
const gradeFiles = [
  "apps/web/src/content/grades/mathquest_j1_types_v1.json",
  "apps/web/src/content/grades/mathquest_j2_types_v1.json",
  "apps/web/src/content/grades/mathquest_j3_types_v1.json"
];
